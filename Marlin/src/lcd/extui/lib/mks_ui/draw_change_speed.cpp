...
void disp_speed_type() {
  lv_imgbtn_set_src_both(buttonMov, editingFlowrate ? "F:/bmp_move_changeSpeed.bin" : "F:/bmp_move_sel.bin");
  lv_imgbtn_set_src_both(buttonExt, editingFlowrate ? "F:/bmp_extruder_sel.bin" : "F:/bmp_speed_extruct.bin");
