...
class Converter {
     ...
     */
    function __construct ($path, $real_name, $out_name ,$dith, $cf, $output_path ) {
     		
        $this->dith = $dith;
        $this->out_name = $output_path . $out_name;
        $this->out_path = $output_path;
        $this->path = $path;
...
$conv = new Converter($img_file, $img_file_name, $output_name, $dith, $cf, $output_path);
